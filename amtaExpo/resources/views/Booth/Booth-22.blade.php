...
<head>
    ...
    <link rel="stylesheet" href="/booth-css/booth-22.css">

    <title>AMTA Expo-Booth 22</title>
</head>
<body>
    ...
    <div id="wrapper">
        ...
        <div id="booth">
            ...
            <div id="img-booth">
                <img src="/booth-img/Booth Background/bg-booth22.png">
            </div>
            ...
            <iframe id="video-player" width="300" height="110"
            src="{{ $video_url }}">
            </iframe> 
        </div>
