...
<head>
    ...
    <link rel="stylesheet" href="/booth-css/booth-18.css">

    <title>AMTA Expo-Booth 18</title>
</head>
<body>
    ...
    <div id="wrapper">
        ...
        <div id="booth">
            ...
            <div id="img-booth">
                <img src="/booth-img/Booth Background/bg-booth18.png">
            </div>
            <div id="info-button">
                <a href="{{ $info_url }}"><img src="/booth-img/Ikon/Info.png" alt="icon" style="width: 50px; height: 50px;"></a>
            </div>

            <iframe id="video-player" width="208" height="195"
            src="{{ $video_url }}">
            </iframe> 
        </div>
